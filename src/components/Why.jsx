    ...
    <div className='overflow-hidden  '>
        ...
        <div className='flex w-full md:justify-center flex-col md:flex-row'>
            ...
            <div className='md:w-2/5 md:p-8 flex flex-col md:inline'>
                ...
                <span className='flex items-center p-2 gap-4 mb-1'><i class="fa-solid fa-hand-holding-dollar text-cyan-600 text-4xl"></i><p className='text-xl'>We offer competitive rates and upfront pricing for all our services.</p></span>
                <span className='flex items-center p-2 gap-4 mb-1'><i class="fa-regular fa-handshake text-cyan-600 text-4xl"></i><p className='text-xl'>We're committed to exceeding your expectations. If you're not completely satisfied, we'll make it right</p></span>
                <span className='flex items-center p-2 gap-4 mb-1'><i class="fa-solid fa-award text-cyan-600 text-4xl"></i><p className='text-xl'>Enjoy peace of mind with our warranties on eligible repairs and installations.</p></span>
