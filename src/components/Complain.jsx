...
function Complain() {
  return (
    ...
    <div className='flex justify-center w-[87%] h-[60vh] text-clip bg-slate-200 m-auto rounded-lg mt-4 mb-5'>
        ...
        <div className='w-2/4 h-[80%]'>
            <form action="submit" className='p-5 bg-zinc-300 m-6 relative flex flex-wrap justify-center items-center rounded-lg'>
                ...
                <textarea name="complain" rows="5" id="complain" placeholder='Message' required className='w-[80%] ml-[1%] p-3 border rounded-lg  '></textarea>
