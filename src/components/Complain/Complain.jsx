...
function Complain() {
  return (
    ...
    <div className='flex flex-col md:flex-row md:justify-center w-[77%] md:h-[60vh] text-clip bg-slate-200 m-auto rounded-lg md:mt-4 md:mb-5 overflow-hidden'>
        <div className='md:w-2/5 flex md:flex-col flex-wrap items-center md:justify-around'>
            <h3 className='md:text-3xl font-extrabold text-cyan-600 md:p-3 p-2'>Resolving your complaints!</h3>
        ...
        <div className='md:w-[50%] h-fit md:h-[100%]'>
            <form action="submit" className='p-5 h-[80%] bg-gray-300 m-6 relative flex flex-wrap justify-center items-center rounded-lg flex-col'>
              <div className='flex flex-wrap gap-5 mx-auto w-[90%]'>
                ...
                <input type="submit" className=' border-black bg-cyan-500 text-white font-bold rounded-lg md:py-3 p-2 md:px-4 md:m-4 md:h-11 md:ml-[1%] cursor-pointer md:mt-10'/>
            </form>
        </div>
    </div>
    </>
